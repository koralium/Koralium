...
import { BigIntArray, BigIntArrayConstructor, TypedArray, TypedArrayConstructor } from 'apache-arrow/interfaces';
import { isAsyncIterable, isIterable, isIteratorResult, isPromise } from './compat';//'apache-arrow/util/compat';
