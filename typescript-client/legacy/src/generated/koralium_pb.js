...
goog.exportSymbol('proto.QueryMetadata', null, global);
 ...
 * @const
 */
proto.Page.repeatedFields_ = [2,3];
...
proto.Page.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadata: (f = msg.getMetadata()) && proto.QueryMetadata.toObject(includeInstance, f)
  };
...
proto.Page.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.QueryMetadata;
      reader.readMessage(value,proto.QueryMetadata.deserializeBinaryFromReader);
...
proto.Page.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.QueryMetadata.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional QueryMetadata metadata = 5;
 * @return {?proto.QueryMetadata}
 */
proto.Page.prototype.getMetadata = function() {
  return /** @type{?proto.QueryMetadata} */ (
    jspb.Message.getWrapperField(this, proto.QueryMetadata, 5));
};


/** @param {?proto.QueryMetadata|undefined} value */
proto.Page.prototype.setMetadata = function(value) {
  jspb.Message.setWrapperField(this, 5, value);
};


proto.Page.prototype.clearMetadata = function() {
 ...
 * @return {boolean}
 */
proto.Page.prototype.hasMetadata = function() {
 ...
 * @constructor
 */
proto.QueryMetadata = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.QueryMetadata.repeatedFields_, null);
};
goog.inherits(proto.QueryMetadata, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.QueryMetadata.displayName = 'proto.QueryMetadata';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.QueryMetadata.repeatedFields_ = [1,2];
 ...
 * @return {!Object}
 */
proto.QueryMetadata.prototype.toObject = function(opt_includeInstance) {
  return proto.QueryMetadata.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.QueryMetadata} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.QueryMetadata.toObject = function(includeInstance, msg) {
  var f, obj = {
    columnsList: jspb.Message.toObjectList(msg.getColumnsList(),
    proto.ColumnMetadata.toObject, includeInstance),
    custommetadataList: jspb.Message.toObjectList(msg.getCustommetadataList(),
 ...
 * @return {!proto.QueryMetadata}
 */
proto.QueryMetadata.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.QueryMetadata;
  return proto.QueryMetadata.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.QueryMetadata} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.QueryMetadata}
 */
proto.QueryMetadata.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.QueryMetadata.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.QueryMetadata.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.QueryMetadata} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.QueryMetadata.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  f = message.getCustommetadataList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
 ...
 */
proto.QueryMetadata.prototype.getColumnsList = function() {
  return /** @type{!Array<!proto.ColumnMetadata>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ColumnMetadata, 1));
};


/** @param {!Array<!proto.ColumnMetadata>} value */
proto.QueryMetadata.prototype.setColumnsList = function(value) {
 ...
 */
proto.QueryMetadata.prototype.addColumns = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.ColumnMetadata, opt_index);
};


proto.QueryMetadata.prototype.clearColumnsList = function() {
  this.setColumnsList([]);
};
 ...
 */
proto.QueryMetadata.prototype.getCustommetadataList = function() {
  return /** @type{!Array<!proto.KeyValue>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.KeyValue, 2));
};


/** @param {!Array<!proto.KeyValue>} value */
proto.QueryMetadata.prototype.setCustommetadataList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 */
proto.QueryMetadata.prototype.addCustommetadata = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.KeyValue, opt_index);
};


proto.QueryMetadata.prototype.clearCustommetadataList = function() {
  this.setCustommetadataList([]);
};
 ...
 * @const
 */
proto.QueryRequest.repeatedFields_ = [3,4];
...
proto.QueryRequest.prototype.getParametersList = function() {
  return /** @type{!Array<!proto.KeyValue>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.KeyValue, 3));
};
...
proto.QueryRequest.prototype.addParameters = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.KeyValue, opt_index);
};
 ...
 * @return {!Array<!proto.KeyValue>}
 */
proto.QueryRequest.prototype.getExtradataList = function() {
  return /** @type{!Array<!proto.KeyValue>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.KeyValue, 4));
};


/** @param {!Array<!proto.KeyValue>} value */
proto.QueryRequest.prototype.setExtradataList = function(value) {
 ...
 * @return {!proto.KeyValue}
 */
proto.QueryRequest.prototype.addExtradata = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.KeyValue, opt_index);
};


proto.QueryRequest.prototype.clearExtradataList = function() {
  this.setExtradataList([]);
};
...
proto.KeyValue.prototype.clearValue = function() {
 ...
 * @return {boolean}
 */
proto.KeyValue.prototype.hasValue = function() {
  return jspb.Message.getField(this, 2) != null;
};
