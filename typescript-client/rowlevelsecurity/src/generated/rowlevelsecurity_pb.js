...
goog.exportSymbol('proto.CubeJsOptions', null, global);
 ...
 * @const
 */
proto.RowLevelSecurityRequest.oneofGroups_ = [[4,5,6]];
...
proto.RowLevelSecurityRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    cubejsoptions: (f = msg.getCubejsoptions()) && proto.CubeJsOptions.toObject(includeInstance, f)
  };
...
proto.RowLevelSecurityRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new proto.CubeJsOptions;
      reader.readMessage(value,proto.CubeJsOptions.deserializeBinaryFromReader);
      msg.setCubejsoptions(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.RowLevelSecurityRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getCubejsoptions();
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.CubeJsOptions.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional CubeJsOptions cubejsOptions = 6;
 * @return {?proto.CubeJsOptions}
 */
proto.RowLevelSecurityRequest.prototype.getCubejsoptions = function() {
  return /** @type{?proto.CubeJsOptions} */ (
    jspb.Message.getWrapperField(this, proto.CubeJsOptions, 6));
};


/** @param {?proto.CubeJsOptions|undefined} value */
proto.RowLevelSecurityRequest.prototype.setCubejsoptions = function(value) {
  jspb.Message.setOneofWrapperField(this, 6, proto.RowLevelSecurityRequest.oneofGroups_[0], value);
};


proto.RowLevelSecurityRequest.prototype.clearCubejsoptions = function() {
  this.setCubejsoptions(undefined);
};
 ...
 * @return {boolean}
 */
proto.RowLevelSecurityRequest.prototype.hasCubejsoptions = function() {
 ...
 * @constructor
 */
proto.CubeJsOptions = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.CubeJsOptions, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.CubeJsOptions.displayName = 'proto.CubeJsOptions';
}
 ...
 * @return {!Object}
 */
proto.CubeJsOptions.prototype.toObject = function(opt_includeInstance) {
  return proto.CubeJsOptions.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.CubeJsOptions} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.CubeJsOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    cubename: jspb.Message.getFieldWithDefault(msg, 1, ""),
    lowercasefirstmembercharacter: jspb.Message.getFieldWithDefault(msg, 2, false)
  };
 ...
 * @return {!proto.CubeJsOptions}
 */
proto.CubeJsOptions.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.CubeJsOptions;
  return proto.CubeJsOptions.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.CubeJsOptions} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.CubeJsOptions}
 */
proto.CubeJsOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setCubename(value);
      break;
    case 2:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setLowercasefirstmembercharacter(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.CubeJsOptions.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.CubeJsOptions.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.CubeJsOptions} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.CubeJsOptions.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCubename();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
  ...
  f = message.getLowercasefirstmembercharacter();
  if (f) {
    writer.writeBool(
      2,
      f
...
/**
 * optional string cubeName = 1;
 * @return {string}
 */
proto.CubeJsOptions.prototype.getCubename = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.CubeJsOptions.prototype.setCubename = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional bool lowerCaseFirstMemberCharacter = 2;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.CubeJsOptions.prototype.getLowercasefirstmembercharacter = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 2, false));
};


/** @param {boolean} value */
proto.CubeJsOptions.prototype.setLowercasefirstmembercharacter = function(value) {
