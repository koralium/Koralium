...
namespace Koralium.Transport.ArrowFlight.Tests
{
        ...
        IArrowTypeVisitor<StructType>
    {
        ...
        public void Visit(TimestampType actualType)
        {
            ...
            Assert.AreEqual(expectedType.Timezone, actualType.Timezone);
            Assert.AreEqual(expectedType.Unit, actualType.Unit);
        }
        ...
        public void Visit(FixedSizeBinaryType actualType)
        {
            ...
            Assert.AreEqual(expectedType.ByteWidth, actualType.ByteWidth);
        }
