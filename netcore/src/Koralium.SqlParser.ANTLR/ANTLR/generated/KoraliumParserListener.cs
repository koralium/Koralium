...
public interface IKoraliumParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterScalar_expression_primitive([NotNull] KoraliumParser.Scalar_expression_primitiveContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="KoraliumParser.scalar_expression_primitive"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitScalar_expression_primitive([NotNull] KoraliumParser.Scalar_expression_primitiveContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="KoraliumParser.scalar_expression_with_alias"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterScalar_expression_with_alias([NotNull] KoraliumParser.Scalar_expression_with_aliasContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="KoraliumParser.scalar_expression_with_alias"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitScalar_expression_with_alias([NotNull] KoraliumParser.Scalar_expression_with_aliasContext context);
	/// <summary>
