...
public partial class KoraliumParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IKoraliumParserVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="KoraliumParser.scalar_expression_primitive"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitScalar_expression_primitive([NotNull] KoraliumParser.Scalar_expression_primitiveContext context) { return VisitChildren(context); }
	/// <summary>
	/// Visit a parse tree produced by <see cref="KoraliumParser.scalar_expression_with_alias"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitScalar_expression_with_alias([NotNull] KoraliumParser.Scalar_expression_with_aliasContext context) { return VisitChildren(context); }
	/// <summary>
