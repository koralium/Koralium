...
public partial class KoraliumParserBaseListener : IKoraliumParserListener {
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="KoraliumParser.scalar_expression_primitive"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterScalar_expression_primitive([NotNull] KoraliumParser.Scalar_expression_primitiveContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="KoraliumParser.scalar_expression_primitive"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitScalar_expression_primitive([NotNull] KoraliumParser.Scalar_expression_primitiveContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="KoraliumParser.scalar_expression_with_alias"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterScalar_expression_with_alias([NotNull] KoraliumParser.Scalar_expression_with_aliasContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="KoraliumParser.scalar_expression_with_alias"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitScalar_expression_with_alias([NotNull] KoraliumParser.Scalar_expression_with_aliasContext context) { }
	/// <summary>
