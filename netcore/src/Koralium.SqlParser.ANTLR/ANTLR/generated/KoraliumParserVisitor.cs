...
public interface IKoraliumParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitScalar_expression_primitive([NotNull] KoraliumParser.Scalar_expression_primitiveContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="KoraliumParser.scalar_expression_with_alias"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitScalar_expression_with_alias([NotNull] KoraliumParser.Scalar_expression_with_aliasContext context);
	/// <summary>
