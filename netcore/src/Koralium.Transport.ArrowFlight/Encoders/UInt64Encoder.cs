...
{
    class UInt64Encoder : IArrowEncoder
    {
        private UInt64Array.Builder _builder;
        private readonly Func<object, object> _getFunc;
        private readonly bool _nullable;

        public UInt64Encoder(Column column)
        {
        ...
        public void Encode(object row)
        {
            ...
            {
                _builder.Append((ulong)val);
            }
        }

        public void NewBatch()
        {
            _builder = new UInt64Array.Builder();
        }
