...
{
    internal static class OrderByHelper_old
    {
            ...
            HashSet<PropertyInfo> usedProperties)
        {
            ...
            {
                OrderByAggregationsVisitor_old orderByAggregationsVisitor = new OrderByAggregationsVisitor_old(groupedStage, visitorMetadata);
            ...
            {
                OrderByPlainVisitor_old visitor = new OrderByPlainVisitor_old(previousStage, visitorMetadata);
