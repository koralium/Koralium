...
namespace Koralium.SqlToExpression.Visitors.Where
{
    ...
    /// 
    /// </summary>
    internal class LikeVisitor_old : BaseVisitor_old
    {
        ...
        public LikeVisitor_old(IQueryStage previousStage, VisitorMetadata visitorMetadata) : base(previousStage, visitorMetadata)
        {
        ...
        private VisitResult VisitBinaryExpression_Internal(Microsoft.SqlServer.TransactSql.ScriptDom.BinaryExpression binaryExpression)
        {
            ...
            var expression = BinaryUtils.CreateBinaryExpression_old(leftResult.Expression, rightResult.Expression, BinaryExpressionType.Add);
        ...
        public override void ExplicitVisit(LikePredicate node)
        {
            ...
            {
                var equalsExpression = PredicateUtils.CreateComparisonExpression_old(
                    leftExpression, 
                    visitResult.Expression, 
