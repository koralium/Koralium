...
{
    internal class WhereVisitor_old : BaseVisitor_old
    {
        ...
        public WhereVisitor_old(IQueryStage queryStage, VisitorMetadata visitorMetadata)
        ...
        {
            LikeVisitor_old likeVisitor = new LikeVisitor_old(_previousStage, _visitorMetadata);
