...
{
    internal class MainVisitor_old : TSqlFragmentVisitor
    {
        ...
        public MainVisitor_old(VisitorMetadata visitorMetadata)
        {
        ...
        private void HandleFromClause(QuerySpecification node)
        {
            ...
            {
                var fromStages = FromHelper_old.GetFromTableStage(node.FromClause, _visitorMetadata);
        ...
        private void HandleWhereClause(QuerySpecification node)
        {
            ...
            {
                var whereStage = WhereHelper_old.GetWhereStage(LastStage, node.WhereClause, _visitorMetadata, _usedProperties);
        ...
        private void HandleGroupByClause(QuerySpecification node, bool containsAggregates)
        {
            ...
            {
                _stages.Add(GroupByHelper_old.GetGroupByStage(LastStage, node.GroupByClause, _usedProperties));
            }
        ...
        private void HandleHavingClause(QuerySpecification node)
        {
            ...
            {
                _stages.Add(HavingHelper_old.GetHavingStage(LastStage, node.HavingClause, _visitorMetadata, _usedProperties));
            }
        }
        ...
        private void HandleOrderByClause(QuerySpecification node)
        {
            ...
            {
                _stages.Add(OrderByHelper_old.GetOrderByStage(LastStage, node.OrderByClause, _visitorMetadata, _usedProperties));
            }
        }
        ...
        private void HandleSelect(QuerySpecification node, bool containsAggregates)
        {
            ...
            {
                _stages.Add(SelectHelper_old.GetSelectAggregateFunctionStage(LastStage, node.SelectElements, _visitorMetadata, _usedProperties));
            }
            else
            {
                _stages.Add(SelectHelper_old.GetSelectStage(LastStage, node.SelectElements, _visitorMetadata, _usedProperties));
            }   
        }
        ...
        private void HandleOffsetClause(QuerySpecification node)
        {
            ...
            {
                var offsetStage = OffsetHelper_old.GetOffsetStage(LastStage, node.OffsetClause, _visitorMetadata);
                ...
                {
                    _stages.Add(OffsetHelper_old.GetOffsetStage(LastStage, node.OffsetClause, _visitorMetadata));
                }
            }
        }
        ...
        private void HandleTop(QuerySpecification node)
        {
            ...
            {
                var offsetStage = OffsetHelper_old.GetOffsetStage(LastStage, node.TopRowFilter, _visitorMetadata);
                ...
                {
                    _stages.Add(OffsetHelper_old.GetOffsetStage(LastStage, node.TopRowFilter, _visitorMetadata));
                }
            }
        }
        ...
        public override void ExplicitVisit(QuerySpecification node)
        {
            ...
            var containsAggregates = ContainsAggregateHelper_old.ContainsAggregate(node.SelectElements);
