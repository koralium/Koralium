...
{
    internal abstract class BaseAggregationVisitor_old : BaseVisitor_old
    {
        private bool _inAggregateFunction = false;
        private readonly GroupedStage _previousStage;
        public BaseAggregationVisitor_old(GroupedStage previousStage, VisitorMetadata visitorMetadata) : base(previousStage, visitorMetadata)
        {
