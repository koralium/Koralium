...
{
    private final KoraliumTypeOld koraliumTypeOld;
    ...
    public KoraliumExecutionColumn(KoraliumTypeOld koraliumTypeOld, int columnId, int returnId, Type prestoType)
    {
        this.koraliumTypeOld = koraliumTypeOld;
    ...
    {
        return koraliumTypeOld.equals(KoraliumTypeOld.OBJECT);
    }

    public boolean isArray()
    {
        return koraliumTypeOld.equals(KoraliumTypeOld.ARRAY);
    }
    ...
    public KoraliumTypeOld getKoraliumTypeOld()
    {
        return koraliumTypeOld;
    }
