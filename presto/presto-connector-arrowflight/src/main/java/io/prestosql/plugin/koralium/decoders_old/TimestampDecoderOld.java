...
public class TimestampDecoderOld
        implements KoraliumDecoderOld
{
    ...
    public TimestampDecoderOld()
    {
        zoneId = ZoneId.of("Z");
        this.type = TIMESTAMP_MILLIS;
    }

    public TimestampDecoderOld(ConnectorSession session, Type type)
    {
    ...
    {
        return new TimestampDecoderOld(session, column.getPrestoType());
    }
