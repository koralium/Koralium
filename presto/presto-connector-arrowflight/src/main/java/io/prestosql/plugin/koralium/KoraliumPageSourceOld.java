...
public class KoraliumPageSourceOld
        extends KoraliumBasePageSource
{
    ...
    {
        FlightStream flightStream = flightClient.getStream(new Ticket(null));
