        ...
        implements ConnectorMetadata
{
    ...
    public Optional<LimitApplicationResult<ConnectorTableHandle>> applyLimit(ConnectorSession session, ConnectorTableHandle handle, long limit)
    {
        ...
        return Optional.of(new LimitApplicationResult<>(tableHandle, true, false));
    }
    ...
    public Optional<TopNApplicationResult<ConnectorTableHandle>> applyTopN(ConnectorSession session, ConnectorTableHandle handle, long topNCount, List<SortItem> sortItems, Map<String, ColumnHandle> assignments)
    {
        ...
        if (tableHandle.getLimit().isPresent() && tableHandle.getSortOrder().isPresent() && tableHandle.getLimit().getAsLong() <= topNCount) {
            return Optional.of(new TopNApplicationResult<>(handle, true, false));
        }
        ...
        return Optional.of(new TopNApplicationResult<>(tableHandle, true, false));
    }
            ...
            Constraint constraint)
    {
        ...
        return Optional.of(new ConstraintApplicationResult<>(tableHandle, TupleDomain.withColumnDomains(unsupported), false));
    }
